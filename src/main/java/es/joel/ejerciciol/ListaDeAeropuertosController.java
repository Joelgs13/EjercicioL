...
import es.joel.ejerciciol.DAO.*;
import es.joel.ejerciciol.Model.AeropuertoPrivadoModel;
import es.joel.ejerciciol.Model.AeropuertoPublicoModel;
import es.joel.ejerciciol.Model.AvionModel;
...
public class ListaDeAeropuertosController {
    ...
    void activarDesactivarAvion(ActionEvent event) {
        ...
        Scene scene;
        try {
            FXMLLoader controlador = new FXMLLoader(EjercicioLApp.class.getResource("activarDesactivarAvion.fxml"));
        ...
        s.initOwner(EjercicioLApp.getStage());
    ...
    void aniadirAeropuerto(ActionEvent event) {
        ...
        Scene scene;
        try {
            FXMLLoader controlador = new FXMLLoader(EjercicioLApp.class.getResource("aniadirEditarAeropuertos.fxml"));
            scene = new Scene(controlador.load());
    ...
    void aniadirAvion(ActionEvent event) {
        ...
        Scene scene;
        try {
            FXMLLoader controlador = new FXMLLoader(EjercicioLApp.class.getResource("aniadirAvion.fxml"));
            scene = new Scene(controlador.load());
